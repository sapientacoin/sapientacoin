...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("sapientacoin-ext-ip");
...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "SapientaCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"107.170.251.206", "107.170.251.206"},
    {"146.185.188.6", "146.185.188.6"},
    {NULL, NULL},
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. SapientaCoin is probably already running."), addrBind.ToString().c_str());
        else
